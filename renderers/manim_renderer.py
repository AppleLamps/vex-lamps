...
def _retime_rendered_video(
    ...
    *,
    ...
    try:
        ...
        raise VisualRendererError(
            f"Timed out retiming generated Manim clip after {config.FFMPEG_COMMAND_TIMEOUT_SEC}s"
        ) from exc
    if result.returncode != 0:
        stderr = (result.stderr or result.stdout or "").strip()
        ...
        if chosen_scene_source is None:
            ...
            for compiler_index, compiler_blueprint in enumerate(compiler_candidates, start=1):
                ...
                try:
                    ...
                    compiler_validation = compiler_validation_report(
                        brief,
                        compiler_blueprint,
                    ...
                    min_compiler_quality = minimum_blueprint_compiler_quality(brief)
                    compiler_acceptable = can_accept_blueprint_compiler_quality(
                        brief,
                        compiler_validation,
                        quality,
